...
**Loading FPKM datasets generated through cuffquant at the gene and isoform levels**
```{r import}
#Gene FPKMs
...
**Creating the CellDataSet (cds) and removing negative controls/empty wells**
```{r}
...
**Using the Monocle Census algorithm to infer RNA copies per cell and creating a new cds**
```{r}
...
**Filtering based on the total mass of each cell and removing cells that fall outside of determined ranges**
